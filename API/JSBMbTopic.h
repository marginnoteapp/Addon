...
@property (nonatomic,readwrite,getter=topicTitle,setter=setTopicTitle:) NSString * title;
...
@property (nonatomic,readonly) NSNumber * flags;
@property (nonatomic,readonly) NSNumber * type;   // 笔记本类型: kCardDeckType/kMindMapType/kDocumentType/kNullType

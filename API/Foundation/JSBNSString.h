...
+ (instancetype)stringWithContentsOfURL:(NSURL *)url usedEncoding:(NSStringEncoding *)enc;
+ (instancetype)stringWithContentsOfFile:(NSString *)path usedEncoding:(NSStringEncoding *)enc;
+ (id)stringWithCapacity:(NSUInteger)capacity;
JSExportAs(stringWithContentsOfFile,
+ (id)_stringWithContentsOfFile:(NSString *)path);
JSExportAs(stringWithContentsOfURL,
+ (id)_stringWithContentsOfURL:(NSURL *)url);
JSExportAs(stringWithContentsOfData,
+ (id)_stringWithContentsOfData:(NSData *)data);

...
#import "MbUIPopoverController.h"
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
    ...
    class_addProtocol([MbUIPopoverController class], @protocol(JSBUIPopoverController));
    context[@"UIPopoverController"] = [MbUIPopoverController class];
...
#else
    class_addProtocol([UIPanMouseGestureRecognizer class], @protocol(JSBUIPanGestureRecognizer));
    context[@"UIPanGestureRecognizer"] = [UIPanMouseGestureRecognizer class];
#endif
    ...
    if(@available(macOS 10.13,*)){
        class_addProtocol([UIWebViewWK class], @protocol(JSBUIWebView));
        context[@"UIWebView"] = [UIWebViewWK class];
    }
    else{
        class_addProtocol([UIWebView class], @protocol(JSBUIWebView));
        context[@"UIWebView"] = [UIWebView class];
    ...
    class_addProtocol([FUISegmentedControl class], @protocol(JSBUISegmentedControl));
    context[@"UISegmentedControl"] = [FUISegmentedControl class];
...
#else
    class_addProtocol([ABFlatSwitch class], @protocol(JSBUISwitch));
    context[@"UISwitch"] = [ABFlatSwitch class];
#endif

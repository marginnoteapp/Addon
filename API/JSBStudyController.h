...
@property (nonatomic,readonly,getter=extensionController) id<JSBUIViewController> extensionPanelController;

- (void)focusNoteInMindMapById:(NSString*)noteId;
- (void)focusNoteInFloatMindMapById:(NSString*)noteId;
- (void)focusNoteInDocumentById:(NSString*)noteId;
- (void)refreshAddonCommands;
- (BOOL)isNoteInReview:(NSString*)noteid;
- (void)openNotebook:(NSString*)notebookId andDocument:(NSString*)docMd5;

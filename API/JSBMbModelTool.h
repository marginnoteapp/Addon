...
+ (NSDictionary*)transDictionaryToJSCompatible:(NSDictionary*)dic;
+ (NSArray*)transArrayToJSCompatible:(NSArray*)arr;
- (MbBookNote*)getSketchNoteForMindMap:(NSString*)topicid focusNoteId:(NSString*)focusNoteId;
- (MbBookNote*)getSketchNoteForDocument:(NSString*)topicid md5:(NSString*)md5 page:(NSInteger)page;
- (NSArray<MbBookNote*>*)getSketchNotesForDocument:(NSString*)topicid md5:(NSString*)md5 page:(NSInteger)page;
- (NSArray<MbBookNote*>*)getSketchNotesForMindMap:(NSString*)topicid;
- (MbBookNote*)createNoteWithTitle:(NSString*)title topicid:(NSString*)topicid;
@end

var SampleViewControllerU = JSB.defineClass('SampleViewControllerU : UITableViewController', {
  viewDidLoad: function() {
    ...
    self.grayButton = function() {
      var buttonBackground = UIImage.imageWithData(NSData.dataWithContentsOfFile(self.mainPath + '/whiteButton.png'));
      var buttonBackgroundPressed = UIImage.imageWithData(NSData.dataWithContentsOfFile(self.mainPath + '/blueButton.png'));
    ...
    self.imageButton = function() {
      ...
      button.setImageForState(UIImage.imageWithData(NSData.dataWithContentsOfFile(self.mainPath + '/UIButton_custom.png')), 0);
  ...
  tableViewCellForRowAtIndexPath: function(tableView, indexPath) {
    if (indexPath.row == 0) {
      var cell = UITableViewCell.makeWithStyleReuseIdentifier(0, 'DisplayCellID');
      ...
      var cell = UITableViewCell.makeWithStyleReuseIdentifier(0, 'SourceCellID');
      cell.selectionStyle = 0;
  ...
  action: function(sender) {
    var alertView = UIAlertView.makeWithTitleMessageDelegateCancelButtonTitleOtherButtonTitles('Alert', 'Button pushed.', null, 'Cancel', ['OK']);
    alertView.show();
  }
});
